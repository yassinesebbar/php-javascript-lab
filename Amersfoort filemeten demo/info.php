...
if (isset($_REQUEST['datum']) && isset($_REQUEST['begintijd']) && isset($_REQUEST['eindtijd'])) {
    ...
    foreach ($kruispunten as $key => $value) {
        ...
        $query = "SELECT SUM(\"TotaalVerkeer\") FROM \"$kruispunt\" WHERE to_char(\"Date\", 'YYYY-MM-DD') = '$datum' and tijd between '$begintijd' and '$eindtijd'";
        ...
        $returnVariable[$key]["TotaalVerkeer"] = $result;
    }
